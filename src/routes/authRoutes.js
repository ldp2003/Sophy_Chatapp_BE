...
router.get('/check-used-phone/:phone', authController.checkPhoneLimiter, authController.checkUsedPhone.bind(authController));
...
router.get('/send-otp-forgot-password', authController.forgotPasswordLimiter, authController.sendOTPForgotPassword.bind(authController));
